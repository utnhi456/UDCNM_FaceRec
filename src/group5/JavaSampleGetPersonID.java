...
public class JavaSampleGetPersonID
{
	public static List<String> ls = new ArrayList<String>();
    public static List<String> main(String perGID) 
    {
    	HttpGetWithEntity httpclient = new HttpGetWithEntity();
    	HttpClient httpclient2 = new DefaultHttpClient();
        try
        {
            URIBuilder builder = new URIBuilder("https://westcentralus.api.cognitive.microsoft.com/face/v1.0/persongroups/"+perGID+"/persons");
